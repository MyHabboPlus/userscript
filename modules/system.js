...
if (window.top==window){
    ...
    $("#header.clearfix").on("click", "#myhp-button-config", function(){
        myhpLightbox(null, text["Preferences"], '<div id="myhp-config">\
            ...
            <div class="myhp-config-option"><div style="float:left;">'+text["Language"]+'</div><select id="prefLang"><option value="auto" '+prefLangValueAuto+'>'+text["LanguageAuto"]+'</option><option value="es" '+prefLangValueES+'>Español</option><option value="en" '+prefLangValueEN+'>English</option><option value="pt" '+prefLangValuePT+'>Português</option></select></div>\
        ...
        $("#myhp-config input, #myhp-config select").change(function() {
            if($(this).is("#prefLang")) {
                ...
                loadLang();
                prefLangValueAuto=""; prefLangValueES=""; prefLangValueEN=""; prefLangValuePT="";
                if(prefLangNew=="auto"){prefLangValueAuto="selected";}else if(prefLangNew=="es"){prefLangValueES="selected";}else if(prefLangNew=="en"){prefLangValueEN="selected";}else if(prefLangNew=="pt"){prefLangValuePT="selected";}
