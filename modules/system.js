    ...
    $("#header.clearfix").on("click", "#myhp-button-config", function(){
        ...
        $("#myhp-config input, #myhp-config select").change(function() {
            if($(this).is("#prefLang")) {
                ...
                loadLang();
                prefLangValueAuto=""; prefLangValueES=""; prefLangValueEN=""; prefLangValuePT=""; prefLangValueFR=""; prefLangValueIT="";
                if(prefLangNew=="auto"){prefLangValueAuto="selected";}else if(prefLangNew=="es"){prefLangValueES="selected";}else if(prefLangNew=="en"){prefLangValueEN="selected";}else if(prefLangNew=="pt"){prefLangValuePT="selected";}else if(prefLangNew=="fr"){prefLangValueFR="selected";}else if(prefLangNew=="it"){prefLangValueIT="selected";}
